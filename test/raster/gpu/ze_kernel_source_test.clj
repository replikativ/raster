(ns raster.gpu.ze-kernel-source-test
  ...
  Pure string tests. Loading the Level Zero runtime namespace opens no driver,
  so they run on every host."
  (:require [clojure.string :as str]
            [clojure.test :refer [deftest is testing]]
            [raster.gpu.ze-runtime]))

(def ^:private canonical-entry @#'raster.gpu.ze-runtime/canonical-entry)
...
(deftest identical-kernels-compile-to-identical-text
  (let [[entry-a source-a] (canonical-entry "segmap_48213" (kernel "segmap_48213" "__acc_48210" "__row_48211"))
        [entry-b source-b] (canonical-entry "segmap_91377" (kernel "segmap_91377" "__acc_91374" "__row_91375"))]
...
(deftest different-kernels-keep-different-entry-points
  (let [[entry-a] (canonical-entry "segmap_1001" (kernel "segmap_1001" "__acc_1002" "__row_1003"))
        [entry-b] (canonical-entry "segmap_1001"
...
(deftest builtins-and-fixed-names-are-untouched
  (let [source (str "__kernel void fixed_kernel(__global half* a) {\n"
        ...
        [entry compiled] (canonical-entry "fixed_kernel" source)]
...
(deftest a-source-without-the-registered-name-is-compiled-as-is
  (is (= ["other_1234" "__kernel void k(){}"]
         (canonical-entry "other_1234" "__kernel void k(){}"))))
