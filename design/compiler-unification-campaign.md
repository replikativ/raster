...
## Current eight-item checkpoint — 2026-09-21
...
| 3. Direct TypedSOAC and retirement | The measured 238-var corpus now has 189 flat TypedSOAC, 1 typed structured-control, 39 scalar, 6 compatible and 3 error rows. The same compile emitted 380 KernelBody and 5 verified compatibility artifacts; 25 programs recorded emission declines. Generated matrix/input-fusion, reductions, ordinary counted stores, AD/SGD and numerical operators use retained typed programs. | Resolve the named residual rows and emission declines before claiming full unification. Source-route coverage is not proof of competitive scheduling or vendor device performance. |
