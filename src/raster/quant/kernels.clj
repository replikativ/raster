...
(descriptor/register-c-helper! 'raster.quant.kernels/wi8-dot-q4
...
(descriptor/register-c-helper! 'raster.quant.kernels/wi8-dot-q4-x8
  {:includes "#include <immintrin.h>\n"
   :gen (fn [c-name]
...
(descriptor/register-op-descriptor! 'raster.quant.kernels/wi8-dot-q4-x8
  {:effects {:pure? false :mutating? true}})
(descriptor/register-buffer-write! 'raster.quant.kernels/wi8-dot-q4-x8 :overwrite 4)
